...
const PRODUCT = {
  ...
  subtitle: "Monogram canvas handbag · Brown",
      ...
      <main className="min-h-screen bg-slate-50 text-slate-900">
        <div className="mx-auto max-w-6xl px-5 py-7 md:px-8 md:py-10">
          ...
          <header className="mb-7 flex items-center justify-between border-b border-slate-200 pb-5">
            <div>
              <div className="text-xl font-semibold">LuxeMarket</div>
          ...
          <section className="grid gap-8 md:grid-cols-2 md:items-start">
            ...
            <div className="rounded-3xl border border-stone-200 bg-white p-5 shadow-sm md:sticky md:top-8">
              <div className="flex min-h-[430px] items-center justify-center overflow-hidden rounded-2xl bg-stone-50">
                <img
                  src="/experiment-assets/lv-speedy-reference.png"
                  alt="Pre-owned Louis Vuitton Speedy 25 handbag"
            ...
            <div>
              <div className="mb-6">
                <div className="mb-2 text-sm font-medium uppercase tracking-[0.16em] text-slate-500">
                  {PRODUCT.condition}
                </div>
              ...
              <section className="mb-5 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-emerald-950/80">
                  This item has been checked for authenticity before being
                  listed for sale.
                </p>
              </section>
              ...
              <section className="mb-5 min-h-[225px] rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                {t.transparency ? (
                  <div className="mt-3">
                    <Row label="Date checked">{PRODUCT.date}</Row>

                    <Row label="Checks completed">
                      Materials, stitching, hardware, serial markings and
                      construction
                    </Row>

                    <Row label="Reference match">
                      Consistent with verified manufacturer specifications
                    </Row>

                    <Row label="Outcome">
                      <span className="font-medium">Passed authentication</span>
                    </Row>
                  </div>
                ) : (
                  <div className="mt-3 flex min-h-[157px] items-start">
                    <div>
                      ...
                      <div className="mt-2 font-medium">Authentic</div>
                    </div>
                  </div>
                )}
              </section>

              <section className="mb-5 min-h-[132px] rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <h2 className="font-semibold">Authentication review</h2>

                <div className="mt-3 flex min-h-[56px] items-center gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-slate-200 font-semibold text-slate-600">
                    {t.expertIdentity ? "EC" : "AS"}
                  </div>

                  {t.expertIdentity ? (
                    <div>
                      <div className="font-medium">Emma Clarke</div>
                      <div className="text-sm text-slate-500">
                        Luxury Authentication Specialist · 9 years&apos;
                        experience
                      </div>
                    </div>
                  ) : (
                    <div>
                      ...
                      <div className="text-sm text-slate-500">
                        Marketplace authentication team
                      </div>
                    </div>
                  )}
                </div>
              ...
              <section className="mb-6 min-h-[178px] rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <h2 className="font-semibold">Authentication record</h2>

                {t.immutability ? (
                  <>
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      The authentication result has been recorded on a
                      blockchain ledger. Once recorded, the entry is designed
                      to be permanent and resistant to alteration.
                    </p>

                    <div className="mt-3 rounded-lg bg-slate-50 p-3 font-mono text-xs text-slate-600">
                      Record: 0x7A4F...91C2 · 18 Aug 2026, 14:32
                    </div>
                  </>
                ) : (
                  <>
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      The marketplace recorded the authentication result on{" "}
                      {PRODUCT.date}.
                    </p>

                    <div className="mt-3 rounded-lg bg-slate-50 p-3 font-mono text-xs text-slate-600">
                      Record: LM-184291 · 18 Aug 2026, 14:32
                    </div>
                  </>
                )}
              </section>
